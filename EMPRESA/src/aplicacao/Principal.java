...
public class Principal
{
	public static void main(String[] args)
	{
		...
		System.out.println("Funcionário: " + novoFuncionario.getNome());
		...
		System.out.println("Salário: " + novoFuncionario.salario());
		System.out.println(" ");
		System.out.println("Funcionário terceiro: " + novoTerceiro.getNome());
